...
class VomarProductDetailsSerializer(BaseProductDetailsSerializer):
    product_id = serializers.CharField(max_length=255, required=True)

    def create(self, validated_data):
        """
        Create and return a new `VomarProductDetails` instance, given the validated resources.
        """
        return VomarProductDetails.objects.create(**validated_data)

    def update(self, instance, validated_data):
        """
        Update and return an existing `VomarProductDetails` instance, given the validated resources.
        """
