...
class DirkProductDetailsSerializer(BaseProductDetailsSerializer):
    product_id = serializers.IntegerField(required=True)

    def create(self, validated_data):
        """
        Create and return a new `DirkProductDetails` instance, given the validated resources.
        """
        return DirkProductDetails.objects.create(**validated_data)

    def update(self, instance, validated_data):
        """
        Update and return an existing `DirkProductDetails` instance, given the validated resources.
        """
