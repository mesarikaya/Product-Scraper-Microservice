...
class MyTestCase(APITestCase):
    ...
    def setUp(self):
        self.Serializer = DirkProductDetailsSerializer
        self.product = DirkProductDetails(product_id=123512412)
    ...
    def test_deserialize(self):
        ...
        serializer2 = DirkProductDetailsSerializer(data=data)
        self.assertTrue(serializer2.is_valid())
        self.assertTrue(len(serializer2.validated_data) == 16)
        print("Serializer save:", serializer2.save())
        self.assertIsInstance(serializer2.save(), DirkProductDetails)

        retrievedValue = DirkProductDetails.objects.filter(product_id=123512412)
